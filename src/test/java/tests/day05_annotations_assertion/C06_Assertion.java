...
public class C06_Assertion {
    ...
    public void test01(){
        ...
        // sayfaya gidebildignizi test edin

        /*
            JUnit'tin konsolda verdigi passed/failed raporu
            if else'in sonucuna bakmaz

            JUnit
                  -kod sorunsuz calisip bittiyse PASSED
                  -kod calisirken expection olusursa FAILED olarak degerlendirir
