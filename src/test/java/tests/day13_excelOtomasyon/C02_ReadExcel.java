...
public class C02_ReadExcel {
    ...
    public void readExcelTesti() throws IOException {
        ...
        System.out.println(sayfa1.getPhysicalNumberOfRows()); // 191 reel olarak kullanilan satir sayisi

        // - Ingilizce Ulke isimleri ve baskentleri bir map olarak kaydedelim

        //Excel'de ingilizce ulke ismi olarak Poland var mi?
        boolean polandVarmi = false;
        for (int i = 0; i <= sayfa1.getLastRowNum(); i++) {

            String satirdakiIngilizceUlkeIsim= sayfa1.getRow(i).getCell(0).toString();
            if (satirdakiIngilizceUlkeIsim.equalsIgnoreCase("Poland")){
                polandVarmi=true;
            }
        }
        ...
        //Excel'de ingilizce ulke ismi olarak Poland odlugunu test edin
